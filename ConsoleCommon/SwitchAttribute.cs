...
namespace ConsoleCommon
{
    public class SwitchAttribute : Attribute
    {
        ...
        public SwitchAttribute(string switchName, bool required=false, int defaultOrdinal=-1, bool dontAllowValues = false)
            : this(switchName, required, defaultOrdinal, new string[0])
        {
        ...
        public SwitchAttribute(string switchName, bool required = false, int defaultOrdinal=-1, params string[] switchValues)
        {
